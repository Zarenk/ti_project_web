  ...
  fields: [
    {
      ...
      type: 'select',
      options: ['DISH', 'BEVERAGE', 'DESSERT', 'PACKAGED'],
      required: false,
      group: 'tipo',
    },
    {
    ...
    },
    {
      ...
      type: 'select',
      options: ['GRILL', 'FRY', 'COLD', 'BAKERY', 'BAR', 'COUNTER'],
      required: false,
      group: 'kitchen',
    },
    {
      ...
      label: 'Presentacion',
      type: 'select',
      options: ['COPA', 'VASO', 'BOTELLA', 'LATA', 'JARRA', 'PORCION'],
      required: false,
      group: 'bebida',
    },
    {
      key: 'serve_temperature',
      label: 'Temperatura de servicio',
      type: 'select',
      options: ['FRIO', 'CALIENTE', 'AMBIENTE'],
      required: false,
      group: 'bebida',
    },
    {
  ...
  [BusinessVertical.RESTAURANTS]: {
    ...
    ui: {
      ...
      customMenuItems: [
        ...
        { label: 'Carta Digital', path: '/dashboard/digital-menu', icon: 'qr-menu' },
      ],
    },
