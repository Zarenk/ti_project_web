...
const accounts: AccountSeed[] = [
  ...
  {
    code: '1041',
    name: 'Banco de la Nación - Detracciones',
    parentCode: '104',
    isPosting: true,
  },
  ...
  {
    code: '14',
    name: 'Cuentas por cobrar al personal, a los accionistas y directores',
    parentCode: '1',
  },
  ...
  {
    code: '19',
    name: 'Depreciación y amortización acumulada',
    parentCode: '1',
  },
  { code: '2', name: 'Pasivo' },
  ...
  {
    code: '2011',
    name: 'Préstamos bancarios locales',
    parentCode: '201',
    isPosting: true,
  },
  ...
  {
    code: '2111',
    name: 'Proveedores nacionales - mercaderías',
    parentCode: '211',
    isPosting: true,
  },
  {
  ...
  {
    code: '24',
    name: 'Cuentas por pagar al personal, a los accionistas y directores',
    parentCode: '2',
  },
  ...
  {
    code: '45',
    name: 'Pérdida por medición de activos no financieros',
    parentCode: '4',
  },
  {
    code: '46',
    name: 'Pérdida por medición de instrumentos financieros',
    parentCode: '4',
  },
  ...
  {
    code: '53',
    name: 'Descuentos, rebajas y bonificaciones obtenidas',
    parentCode: '5',
  },
  ...
  {
    code: '56',
    name: 'Ganancia por medición de activos no financieros',
    parentCode: '5',
  },
  { code: '57', name: 'Ingresos por servicios prestados', parentCode: '5' },
  {
    code: '58',
    name: 'Participación en resultados de subsidiarias y asociadas',
    parentCode: '5',
  },
  {
    code: '59',
    name: 'Ganancia por medición de instrumentos financieros',
    parentCode: '5',
  },
  ...
  {
    code: '63',
    name: 'Pérdidas por investigación y desarrollo',
    parentCode: '6',
  },
  ...
  {
    code: '7011',
    name: 'Venta de mercaderías - nacional',
    parentCode: '701',
    isPosting: true,
  },
  {
  ...
  {
    code: '78',
    name: 'Participación en resultados de subsidiarias',
    parentCode: '7',
  },
  {
    code: '79',
  ...
  {
    code: '88',
    name: 'Resultado del ejercicio - participaciones',
    parentCode: '8',
  },
  ...
  {
    code: '9011',
    name: 'Bienes recibidos en consignación - terceros',
    parentCode: '901',
    isPosting: true,
  },
...
async function main() {
  ...
  for (const acc of accounts) {
    const parentId = acc.parentCode
      ? accountIdByCode.get(acc.parentCode)
      : null;
