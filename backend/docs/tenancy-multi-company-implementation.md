...
3. Actualizar pruebas de integracion o e2e si existen (busque en `backend/test`) para reflejar el flujo multicompanía completo.
...
Cumplir estos pasos garantiza que el backend exponga correctamente la funcionalidad multicompanía y permita al frontend construir las pantallas correspondientes con datos confiables.
