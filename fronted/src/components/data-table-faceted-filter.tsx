...
export function DataTableFacetedFilter<TData, TValue>({
  ...
  // Construir facetsMap directamente desde facets
  const facetsMap = new Map(facets || []);
                ...
                return (
                  <CommandItem
                    ...
                    onSelect={() => {
                        ...
                        onChange?.(filterValues); // Llama al onChange con los valores actualizados
                    }}
                    >
                    <div
                      className={cn(
                    ...
                    {facetsMap.get(option.label) !== undefined && (
                      <span className="ml-auto flex h-4 w-4 items-center justify-center font-mono text-xs">
                        {facetsMap.get(option.label)}
                      </span>
                    )}
                  </CommandItem>
                );
