...
export function OnboardingWizardBanner() {
  ...
  return (
    <div className="no-print mx-4 mt-2 mb-4 rounded-2xl border border-indigo-100 bg-indigo-50 p-4 text-indigo-900 shadow-sm dark:border-indigo-800/70 dark:bg-indigo-950/40 dark:text-indigo-100">
