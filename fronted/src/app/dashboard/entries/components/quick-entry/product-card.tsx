...
function hasDetailContent(product: ProductCardItem): boolean {
...
export function ProductCard({
  ...
  return (
    ...
    >
      {/* Image */}
      <div
        className="relative aspect-[4/3] w-full cursor-pointer overflow-hidden bg-muted/30"
        onClick={inCart ? onIncrement : onAdd}
      >
        {imageUrl ? (
          <img
            src={imageUrl}
      ...
      <div className="flex flex-1 flex-col gap-1 p-3">
        ...
        <div className="mt-auto flex items-center justify-between gap-2 pt-2">
          <div className="flex flex-col">
            <span className="text-[10px] text-muted-foreground">Precio compra</span>
